                ...
                <div className={styles.MainColumn}>
                    ...
                    <div className={styles.Text}>
                        <En>
                            ...
                            AGENCY REPRESENTING TALENT IN THE FIELDS OF FASHION
                            AND BEAUTY. FOUNDED IN SAINT-PETERSBURG IN 2022, YY
                            STUDIOS HAS CULTIVATED A COMMUNITY OF ARTISTS AND
                            AGENT WHO FOCUS ON THE DISCIPLINES OF IMAGE MAKING,
                            STYLING, HAIR, MAKEUP, CASTING AND CREATIVE
                            DIRECTION.
                        </En>
                        <Ru>
                            YY STUDIOS — МЕСТНОЕ АГЕНТСТВО, ПРЕДСТАВЛЯЮЩЕЕ
                            ТАЛАНТЫ В ОБЛАСТИ МОДЫ И КРАСОТЫ. YY STUDIOS,
                            ОСНОВАННАЯ В САНКТ-ПЕТЕРБУРГЕ В 2022 ГОДУ, СОЗДАЛА
                            СООБЩЕСТВО ХУДОЖНИКОВ И АГЕНТОВ, КОТОРЫЕ
                            ФОКУСИРОВАНЫ НА ДИСЦИПЛИНАХ ИЗГОТОВЛЕНИЯ ИМИДЖА,
                            УКЛАДКИ, ПРИЧЕСОК, МАКИЯЖА, КАСТИНГА И ТВОРЧЕСКОГО
                            НАПРАВЛЕНИЯ.
                        </Ru>
                    </div>
                    <div style={{ marginTop: "1em" }} className={styles.Text}>
                        <En>
                            ...
                            STUDIOS WORKS WITH THEIR ARTISTS AND CLIENTS ON
                            PROJECTS OF ALL TYPES INCLUDING BRAND AND PRODUCT
                            DEVELOPMENT, IMAGE LICENSING, EXHIBITIONS AND BOOK
                            PUBLISHING.
                        </En>
                        <Ru>
                            ПОМИМО ПОВСЕДНЕВНОГО УПРАВЛЕНИЯ И ПРЕДСТАВИТЕЛЬСТВА,
                            YY STUDIOS РАБОТАЕТ СО СВОИМИ ХУДОЖНИКАМИ И
                            КЛИЕНТАМИ ПО ПРОЕКТАМ ВСЕХ ТИПОВ, ВКЛЮЧАЯ РАЗРАБОТКУ
                            БРЕНДА И ПРОДУКЦИИ, ЛИЦЕНЗИРОВАНИЕ ИЗОБРАЖЕНИЙ,
                            ВЫСТАВКИ И ИЗДАНИЕ КНИГ.
                        </Ru>
                    </div>
                </div>
